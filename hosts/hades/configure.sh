...
curl "https://github.com/psevdaisthisi/poly-dark/archive/master.zip" -L -o /tmp/polydark.zip
...
chgrp users "/home/${_user}/vol1" "/home/${_user}/vol2"
chmod g=rwx "/home/${_user}/vol1" "/home/${_user}/vol2"
